package com.whf.statemachine.config;
...
public class LogResultAspect {
    ...
    //拦截 LogHistory注解
    @Pointcut("@annotation(com.whf.statemachine.annotation.StateResult)")
    ...
    public Object logResultAround(ProceedingJoinPoint pjp) throws Throwable {
        ...
        // 获取LogHistory注解
        StateResult logResult = method.getAnnotation(StateResult.class);
